...
static MunitTest clockServiceTests[] = {
    ...
    {           "/emptyAfterDestroy",            emptyAfterDestroy, testSetup, testTearDown, MUNIT_TEST_OPTION_NONE, NULL},
    {    "/scheduleButItsNotTimeYet",     scheduleButItsNotTimeYet, testSetup, testTearDown, MUNIT_TEST_OPTION_NONE, NULL},
    {          "/scheduleAndItsTime",           scheduleAndItsTime, testSetup, testTearDown, MUNIT_TEST_OPTION_NONE, NULL},
    { "/schedule100msAndIts99msTime",  schedule100msAndIts99msTime, testSetup, testTearDown, MUNIT_TEST_OPTION_NONE, NULL},
    {"/schedule100msAndIts101msTime", schedule100msAndIts101msTime, testSetup, testTearDown, MUNIT_TEST_OPTION_NONE, NULL},
    {   "/scheduleAndItsTooOverTime",    scheduleAndItsTooOverTime, testSetup, testTearDown, MUNIT_TEST_OPTION_NONE, NULL},
    {     "/scheduleAndItsTimeTwice",      scheduleAndItsTimeTwice, testSetup, testTearDown, MUNIT_TEST_OPTION_NONE, NULL},
    {     "/scheduleTwiceAndItsTime",      scheduleTwiceAndItsTime, testSetup, testTearDown, MUNIT_TEST_OPTION_NONE, NULL},
